...
CREATE TABLE IF NOT EXISTS payment_cases (
    ...
    customer_email TEXT,
    customer_phone TEXT,
    amount BIGINT NOT NULL, -- in paise (e.g. 49900 = ₹499.00)
...
-- Index for querying cases by status and creation time
...
CREATE TABLE IF NOT EXISTS audit_logs (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    case_id TEXT NOT NULL, -- Can be UUID or 'system' / 'webhook'
    step TEXT NOT NULL, -- DETECT, DIAGNOSE, DECIDE, EXECUTE, RECOVERED, ERROR, SETTINGS
...
-- 3. APP SETTINGS (Kill Switch & Configuration)
...
-- Trigger to auto-update updated_at on payment_cases
